...
h3 = f3.Get("Timing_detector_Trailing")
h4 = f4.Get("Timing_detector_Trailing")
...
h2.SetTitle("Time of flight - collision point to HCAL(Trailing)")
h2.SetTitle("Time of flight - collision point to HCAL(Trailing)")
h2.SetXTitle("T [ns]")
h2.SetXTitle("T [ns]")
