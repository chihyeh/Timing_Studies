...
f2= ROOT.TFile.Open("/Users/ms08962476/singularity/TIming_Studies/tev5mm_pythia6_zprime5tev_ww_with_Eta_cut_for_component_check.root",'r')
...
h1 = f1.Get("Trailing_particle_ID_T")
h2 = f2.Get("Trailing_particle_ID_T")
...
h1.SetTitle("Trailing particle ID (T)")
h1.SetTitle("Trailing particle ID (T)")
...
c.Print("Try_Trailing_particle_ID_T.pdf")
